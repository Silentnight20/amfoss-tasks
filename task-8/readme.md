Actually I took some time in understanding the question. As I understood the question, I tried the command given the task-set document, which gave me all commits in cms.
